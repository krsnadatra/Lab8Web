...
if (isset($_POST['tambah'])){
	if(updatebarangmasuk($_POST['notrans'], $_POST['tgl'], $_POST['jam'], $_POST['idbarang'], $_POST['idsup'], $_POST['jumlah'], ($_GET['id']))){
			header('location:barang_masuk.php');
	}else{
		echo "Maaf Update data gagal";
	}
}
$result=tampilbarangmasuk_per_id($_GET['id']);
...
<form action="" method="post">
	<table border="0" align="center" style="height:300;">
		...
		<tr>
			<td>Nama Supplier</td>
			<td><input type="text" name="idsup" value="<?php echo $row['id_supplier'];?>"></td>
		</tr>
