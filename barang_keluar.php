...
if(isset($_POST['submit'])){
	if(barang_keluar($_POST['notrans'], $_POST['date'], $_POST['time'], $_POST['idbarang'], $_POST['jumlah'])){
		echo "<script language='javascript'>
			alert('DATA BARANG KELUAR BERHASIL DITAMBAH')
			</script>";
	}else{
		echo "<script language='javascript'>
...
<div class="body">
<br>
<center><p>Tabel Barang Keluar</p></center>
<br>
<div id="tabel">
<form action="" method="post">
	...
	<i>NB : Jika Id barang sudah ada cukup mengupdate jumlah data & jam nya saja</i>
</form>
...
if(isset($_GET['cari'])){
$result=hasil_cari_keluar($_GET['cari']);
}
while ($row=mysqli_fetch_assoc($result)) { ?>
		...
		<tr>
			...
			<td align="center"><a href="updatebarangkeluar.php?id= <?php echo $row['no_trans']; ?> "><img src="img/edit-black.png"></a> | 
			<a href="hapusbarangkeluar.php?id= <?php echo $row['no_trans']; ?> "><img src="img/delete-black.png"></a></td>
			<?php $no++;?>
		</tr>
		<?php }?>
